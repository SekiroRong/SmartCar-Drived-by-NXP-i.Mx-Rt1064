 ...
 * 定义 KEY 编号对应的管脚
 */
//PIN_enum KEY_PTxn[KEY_MAX] = {B9,  B11,  B10,  B29,  B28,  B5,  B6,  B7};
//PIN_enum KEY_PTxn[KEY_MAX] = {C28,  C25,  C26,  C30,  C27,  B5,  B6,  B7};
PIN_enum KEY_PTxn[KEY_MAX] = {C30,  C25,  C28,  C27,  C26,  C29,  B10,  B11  ,B28};
void    key_init(KEY_e key)
{
    if(key < KEY_MAX)
    {
        gpio_init(KEY_PTxn[key], GPI, 1, GPIO_PIN_CONFIG);
    }
    else
    {
        key = KEY_MAX;
